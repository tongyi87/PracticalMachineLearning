...
####Conclusion
The training set is partitioned to perform cross-validation. The result shows that Random forest model(0.9951) has a higher accuracy than Decision Tree(0.7468). With such high accuracy, Random Forest is choosen for the submission.
